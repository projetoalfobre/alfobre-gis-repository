...
<qgis version="3.34.3-Prizren">
  <identifier>Toponímia árabe de Portugal</identifier>
  <parentidentifier></parentidentifier>
  <language>PRT</language>
  <type>dataset</type>
  <title>Toponímia árabe de Portugal</title>
  <abstract>Locations from paper Lopes, David (1922). Toponímia árabe de Portugal. Revista Lusitana, vol. 24, 257-273. Lisboa: Livraria Clássica Editora.</abstract>
  ...
  <links>
    <link description="Alfobre Geodata Catalog" url="https://a-geocat.alfobre.com/" format="" mimeType="" type="https" size="" name="A-GeoCat"/>
    <link description="Alfobre Official Website" url="https://alfobre.com" format="" mimeType="" type="https" size="" name="Alfobre"/>
  </links>
  <dates/>
  <fees></fees>
